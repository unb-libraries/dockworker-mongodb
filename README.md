# Dockworker for Mongodb Instances
## Develop, Test and Deploy into Kubernetes Docker-Based Mongodb Applications
...
This package extends the base [dockworker](https://github.com/unb-libraries/dockworker) framework to provide additional functionality for Mongodb applications.
...
* [docker](https://www.docker.com)/[docker-compose](https://docs.docker.com/compose/) - An installation HowTo for OSX and Linux [is located here, in section 2.](https://github.com/unb-libraries/dockworker/wiki/2.-Setting-Up-Prerequisites).
...
- Consequently, the contents of this repository [unb-libraries/dockworker-mongodb] are licensed under the [MIT License](http://opensource.org/licenses/mit-license.html). This license explicitly excludes:
